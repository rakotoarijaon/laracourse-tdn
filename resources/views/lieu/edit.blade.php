...
@section('body')
    ...
    <div class="row">
      <section class="form my-4 mx-0">
        <div class="container">
          <a href="{{route('lieu.index')}}"><i class="fa-solid fa-arrow-left fa-2x icons"></i></a>
          <div class="row no-gutters">
            ...
            <!--endlogo-->
            <!--form-->
              <form action="{{route('lieu.update',$lieu->id)}}" method="POST">
                  @csrf
                <div class="form-row">
                  <div class="col-lg-7">
                    <label  class="label">Lieu</label>
                    <input type="text" name="lieu_nom" placeholder="nom" class="form-control my-3  " value="{{$lieu->lieu_nom}}">
                  </div>
                </div>
                <!--
                  <div class="form-row">
